const es = {
  ...
  dashboard: {
    page: {
      ...
      description:
        "¡Bienvenido de nuevo! Aquí tienes un resumen de tus métricas de negocio.",
    },
    errors: {
  ...
  forms: {
    page: {
      ...
      description:
        "Recopila información detallada de la cuenta y configura preferencias a la vez.",
    },
    sections: {
  ...
  settings: {
    page: {
      title: "Configuración",
      description:
        "Actualiza la información de tu perfil y las preferencias de notificación.",
    },
    fields: {
  ...
  blank: {
    page: {
      ...
      content:
        "Personaliza esta página añadiendo componentes o visualizaciones de datos.",
    },
  },
  system: {
    error: {

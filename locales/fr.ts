const fr = {
  ...
  dashboard: {
    page: {
      ...
      description:
        "Content de vous revoir ! Voici un résumé de vos indicateurs métier.",
    },
    errors: {
  ...
  forms: {
    page: {
      ...
      description:
        "Collectez des informations détaillées sur le compte et configurez les préférences en une seule fois.",
    },
    sections: {
  ...
  settings: {
    page: {
      title: "Paramètres",
      description:
        "Mettez à jour les informations de votre profil et vos préférences de notification.",
    },
    fields: {
      namePlaceholder: "Nom",
  ...
  blank: {
    page: {
      ...
      content:
        "Personnalisez cette page en ajoutant des composants ou des visualisations de données.",
    },
  },
  system: {
    error: {
